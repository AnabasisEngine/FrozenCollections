...
/// </remarks>
internal sealed class RightHandStringComparer : PartialStringComparerBase
{
    ...
    public override bool EqualsPartial(string? x, string? y) => x.AsSpan(x!.Length + Index, Count).Equals(y.AsSpan(y!.Length + Index, Count), StringComparison.Ordinal);
